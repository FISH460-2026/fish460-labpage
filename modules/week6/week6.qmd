...
Each research team member will link their data sheet(s) and upload notes on experimental setup, methods, and protocols to their github repo README in Week 6 Lab. **Each member needs to upload at least 1 item.** You will be graded individually for checking this off.

#### 🎯 Lab Goals:

1.  Set up your experimental tanks

2.  Select your crabs!

3.  Label EVERYTHING

4.  Run any initial trials as per your research team's plan

5.  Record methods with photographs and written protocols

6.  Upload records into github repo
:::
...
-   [ ] Label your 96 well plate with tape, indicate your team name, date, plate number (if multiple plates), and any other relevant info
...
-   [ ] Pull `T1` measurement. Pipette **200 𝛍L** aliquots from each cup *MAKING SURE TO CHANGE TIPS IN BETWEEN* , and place them in your 96 well plate
...
-   [ ] Clean up your workspace and dispose of resazurin waste by rinsing it down the lab sink with the water running. Thoroughly rinse all plates, cups, beakers, etc. and leave out to dry and reuse. 

### Hemolymph extraction
Hemolymph is the circulatory fluid of invertebrates, analogous to blood in vertebrates. It contains cells and proteins that are involved in immune responses, nutrient transport, and other physiological processes. Hemolymph extraction allows researchers to analyze these components to understand the health and immune status of the crabs.
