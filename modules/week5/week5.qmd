...
Each research team will link their data sheet(s) and upload photographs, notes on methods, and protocols to their github repo README in Week 5 Lab.

#### 🎯 Lab Goals:

1.  Set up exeriments

2.  Take baseline data measurements (if needed)

3.  Populate data sheets (data entry!)

4.  Record methods with photographs and written protocols
:::
...
-   [ ] Lay out a plastic cup or beaker (depending on size of crab) for each crab that is undergoing the metabolic activity resazurin trial

-   [ ] Lay out an additional 3 cups for your blanks
...
-   [ ] Fill each cup with **35 mL** of resazurin working solution, if needed, add just enough to submerge any larger crabs. Record volumes for each adjusted cup.
